...
<div class="flex-col">
  ...
  <div style="margin-top:6px;">
    <div v-after class="section-label" style="margin-bottom:4px;">Accumulation Trace</div>
    <table class="trace-table" style="font-size:.65rem;">
      <thead v-after><tr><th>i</th><th>total += i</th><th>total</th></tr></thead>
      <tbody>
        <tr v-click><td>1</td><td>0 + 1</td><td>1</td></tr>
        <tr v-click><td>2</td><td>1 + 2</td><td>3</td></tr>
        <tr v-click><td>3</td><td>3 + 3</td><td>6</td></tr>
        <tr v-click><td>4</td><td>6 + 4</td><td>10</td></tr>
        <tr v-click style="background:#e3f2fd"><td>5</td><td>10 + 5</td><td>15</td></tr>
      </tbody>
    </table>
  </div>
</div>
