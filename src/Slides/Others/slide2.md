...
<Slide2 topic="Python if Statement — Introduction">
  <template #content>
...
<Slide2 topic="Python if Statement — Syntax">
  <template #content>
...
<Slide2 topic="Python else Statement">
  <template #content>
...
<Slide2 topic="Python else — Without elif">
  <template #content>
...
<Slide2 topic="Python elif Statement">
  <template #content>
...
<Slide2 topic="Activity — if / elif / else Practice">
  <template #content>
<div class="slide-h1" style="margin-bottom:12px;">🏋️ <span class="highlight">Practice Challenge!</span></div>

<div class="activity-box">
  <div class="act-title">Activity 1: Decision Making</div>

  <div class="act-task" v-click>
    <strong>Task A — Temperature Advisor 🌡️</strong>
    <div style="margin-top:6px;display:flex;flex-direction:column;gap:3px;">
      <div class="mono" style="color:#a8ff78;font-size:.72rem;">Get a temperature (integer) from the user</div>
      <div class="mono" style="color:#a8ff78;font-size:.72rem;">temp > 35 → "☀️ Very Hot! Stay hydrated"</div>
      <div class="mono" style="color:#a8ff78;font-size:.72rem;">temp > 25 → "😊 Warm and pleasant"</div>
      <div class="mono" style="color:#a8ff78;font-size:.72rem;">temp > 15 → "🧥 Cool, carry a jacket"</div>
      <div class="mono" style="color:#a8ff78;font-size:.72rem;">else      → "🥶 Very Cold!"</div>
    </div>
    <div class="hint">Use int(input()) to get the temperature</div>
  </div>

  <div class="act-task" v-click>
    <strong>Task B — Spot the Bug 🐛</strong>
    <div style="margin-top:6px;">
      <div class="mono" style="color:#ff9a9a;font-size:.72rem;">score = 85<br>
if score >= 90<br>
&nbsp;&nbsp;&nbsp;&nbsp;print("A+")<br>
elif score >= 75:<br>
print("A")<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;print("B")</div>
    ...
    <div class="hint">Hint: Look for missing colons and wrong indentation!</div>
  </div>

  <div class="act-task" v-click>
    <strong>Bonus — Real World 🚗</strong><br>
    <div class="mono" style="color:#ffd166;font-size:.72rem;margin-top:5px;">Write a program to check fuel level (0-100):<br>
    > 50 → "Tank is fine 🟢"<br>
    > 20 → "Refuel soon 🟡"<br>
    else → "URGENT: Low fuel 🔴"</div>
    <div class="hint">Try with values: 75, 35, 10</div>
  </div>
</div>
  </template>
</Slide2>
...
<Slide2 topic="Shorthand if...else (Ternary)">
  <template #content>
<div class="slide-h1" style="margin-bottom:12px;">Shorthand <span class="highlight">if ... else</span></div>
...
<Slide2 topic="Nested if Statements">
  <template #content>
...
<Slide2 topic="Python pass Statement">
  <template #content>
...
<Slide2 topic="pass vs Comments — Comparison">
  <template #content>
...
<!-- ═══════════════════════════════════════════════════════
     SLIDE 22 — SECTION DIVIDER: MATCH-CASE
═══════════════════════════════════════════════════════ -->

<div style="background:linear-gradient(135deg,#805ad5,#553c9a); height:65vh; margin:-24px; margin-top:1px; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; padding:40px;">

<div v-after style="font-size:3.5rem;margin-bottom:10px;">🎯</div>
<h2 v-after style="color:#fff;font-size:2.2rem;font-weight:900;margin-bottom:10px;">Python match Statement</h2>
<p v-after style="color:rgba(255,255,255,.75);font-size:.88rem;max-width:450px;">Python 3.10's powerful pattern matching — like a smart switch-case!</p>

<div v-after style="display:flex;gap:10px;margin-top:20px;justify-content:center;">
  <span class="pill" style="background:rgba(255,255,255,.15);color:#fff;">Python 3.10+</span>
  <span class="pill" style="background:rgba(255,255,255,.15);color:#fff;">Pattern Matching</span>
  <span class="pill" style="background:rgba(255,255,255,.15);color:#fff;">Wildcard _</span>
</div>
</div>
...
<Slide2 topic="Python match Statement — Syntax">
  <template #content>
...
<Slide2 topic="match-case — Execution Flow">
  <template #content>
...
<Slide2 topic="if-elif-else vs match-case — Comparison">
  <template #content>
...
<Slide2 topic="match-case — Multiple Values per Case">
  <template #content>
...
<!-- ═══════════════════════════════════════════════════════
     SLIDE 28 — COMPLETE MINI PROJECT
═══════════════════════════════════════════════════════ -->

<Slide2 topic="Mini Project — Student Report Card">
  <template #content>
<div class="slide-h1" style="margin-bottom:10px;">🎓 Mini Project: <span class="highlight">Student Report Card</span></div>

<div class="g2" style="gap:14px;">

<div class="flex-col" style="gap:8px;">
  <div class="slide-h3" v-click>Complete Program</div>

  <div v-after style="background:#1a1f36;border-radius:10px;padding:12px 18px;font-family:'Fira Code',monospace;font-size:.71rem;line-height:1.85;">
    <span style="color:#636e80;"># Student Report Card Generator</span><br>
    <span style="color:#61dafb;">name</span>  = <span style="color:#a8ff78;">input</span>(<span style="color:#f1fa8c;">"Enter student name: "</span>)<br>
    <span style="color:#61dafb;">marks</span> = <span style="color:#ffd166;">int</span>(<span style="color:#a8ff78;">input</span>(<span style="color:#f1fa8c;">"Enter marks (0-100): "</span>))<br><br>
    <span style="color:#636e80;"># Determine grade using if-elif-else</span><br>
    <span style="color:#ff79c6;">if</span> <span style="color:#61dafb;">marks</span> >= <span style="color:#ffd166;">90</span>:<br>
    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#61dafb;">grade</span> = <span style="color:#f1fa8c;">"A+"</span><br>
    <span style="color:#61dafb;">elif</span> <span style="color:#61dafb;">marks</span> >= <span style="color:#ffd166;">80</span>:<br>
    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#61dafb;">grade</span> = <span style="color:#f1fa8c;">"A"</span><br>
    <span style="color:#61dafb;">elif</span> <span style="color:#61dafb;">marks</span> >= <span style="color:#ffd166;">70</span>:<br>
    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#61dafb;">grade</span> = <span style="color:#f1fa8c;">"B"</span><br>
    <span style="color:#61dafb;">elif</span> <span style="color:#61dafb;">marks</span> >= <span style="color:#ffd166;">50</span>:<br>
    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#61dafb;">grade</span> = <span style="color:#f1fa8c;">"C"</span><br>
    <span style="color:#ffd166;">else</span>:<br>
    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#61dafb;">grade</span> = <span style="color:#f1fa8c;">"F"</span><br><br>
    <span style="color:#636e80;"># Status using match-case</span><br>
    <span style="color:#ffd166;">match</span> <span style="color:#61dafb;">grade</span>:<br>
    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#a8ff78;">case</span> <span style="color:#f1fa8c;">"A+"</span> <span style="color:#ff9900;">|</span> <span style="color:#f1fa8c;">"A"</span>:<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#61dafb;">status</span> = <span style="color:#f1fa8c;">"Distinction 🌟"</span><br>
    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#a8ff78;">case</span> <span style="color:#f1fa8c;">"B"</span> <span style="color:#ff9900;">|</span> <span style="color:#f1fa8c;">"C"</span>:<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#61dafb;">status</span> = <span style="color:#f1fa8c;">"Pass ✅"</span><br>
    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#a8ff78;">case</span> <span style="color:#ff9900;">_</span>:<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#61dafb;">status</span> = <span style="color:#f1fa8c;">"Fail ❌"</span><br><br>
    <span style="color:#a8ff78;">print</span>(<span style="color:#f1fa8c;">f"\n--- Report Card ---"</span>)<br>
    <span style="color:#a8ff78;">print</span>(<span style="color:#f1fa8c;">f"Name  : {name}"</span>)<br>
    <span style="color:#a8ff78;">print</span>(<span style="color:#f1fa8c;">f"Marks : {marks}"</span>)<br>
    <span style="color:#a8ff78;">print</span>(<span style="color:#f1fa8c;">f"Grade : {grade} — {status}"</span>)
  </div>
</div>

<div class="flex-col" style="gap:8px;">
  <div class="slide-h3" v-click>📤 Sample Output</div>

  <div v-after class="output-box" style="font-size:.72rem;">
    <span class="warn">Enter student name: Priya</span><br>
    <span class="warn">Enter marks: 85</span><br><br>
    --- Report Card ---<br>
    Name  : Priya<br>
    Marks : 85<br>
    Grade : A — Distinction 🌟
  ...
  <div v-click class="flex-col" style="gap:6px;margin-top:4px;">
    <div class="card card-red"><div class="small-text">🔴 <strong>Lines 5–14:</strong> if-elif-else determines the grade letter</div></div>
    <div v-after class="card card-purple"><div class="small-text">🟣 <strong>Lines 16–21:</strong> match-case converts grade to status text</div></div>
    <div v-after class="card card-green"><div class="small-text">🟢 <strong>Lines 23–26:</strong> f-strings print the formatted report card</div></div>
    <div v-after class="callout callout-info">
      <span class="callout-icon">💡</span>
      <div>This program combines <strong>if-elif-else</strong> (for ranges) and <strong>match-case</strong> (for exact values) — the best of both!</div>
    </div>
  </div>
</div>
...
<Slide2 topic="Conditional Statements — Quick Reference">
  <template #content>
